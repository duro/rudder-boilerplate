# Rudder Isomorphic Boilerplate

## About

This is a the Isomorphic / Universal starter for the Rudder web platfrom
...
* [Immutable](https://facebook.github.io/immutable-js/): A library to create immutable data types. This is used for all core state in the app.
* [Redux](https://github.com/rackt/redux)'s futuristic [Flux](https://facebook.github.io/react/blog/2014/05/06/flux.html) implementation
* [Redux Dev Tools](https://github.com/gaearon/redux-devtools) for next generation DX (developer experience). Watch [Dan Abramov's talk](https://www.youtube.com/watch?v=xsSnOQynTHs).
* [React Router Redux](https://github.com/reactjs/react-router-redux) Redux/React Router bindings.
* [redux-thunk](https://github.com/gaearon/redux-thunk): Redux Middleware that allows you to write action creators that return a function instead of an action.
